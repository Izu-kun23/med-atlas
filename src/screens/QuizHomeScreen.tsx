                    ...
                    <View style={styles.cardContent}>
                      ...
                      <View style={styles.statsContainer}>
                        ...
                        {subject.averageScore > 0 && (
                          <View style={[styles.statBadge, styles.scoreBadge]}>
                            ...
                            <Text style={[styles.statBadgeText, { color: Colors.successGreen }]}>
                      ...
                      <View style={styles.quizActionSection}>
                        ...
                        <View style={styles.performanceRow}>
                          ...
                          <View style={styles.perfStat}>
                            <Text style={styles.perfValue}>{subject.averageScore || 0}%</Text>
                          ...
                          {generatingQuiz === subject.id ? (
                            ...
                            <>
                              ...
                              <Text style={styles.startQuizBtnText}>
                                {(!subject.notesCount || subject.notesCount === 0) ? 'No Notes' : 'Start Quiz'}
                              </Text>
                            </>
                          )}
                        </TouchableOpacity>
            ...
            <View style={styles.scoreHistoryStats}>
              ...
              <View style={styles.scoreStatItem}>
                <Text style={styles.scoreStatValue}>
                  {recentQuizzes.length > 0 ? Math.max(...recentQuizzes.map((q) => q.score)) : 0}%
                </Text>
